...
export const AMP_INPUT_TERMINALS = ['RCA', 'XLR', 'Main In', 'Optical', 'Coaxial', 'USB', 'Bluetooth'];
// 출력 단자 — 평면 나열. Record Out = Tape Out 으로 통합
export const AMP_OUTPUT_TERMINALS = ['스피커 출력', 'Pre Out', 'RCA Out', 'XLR Out', 'Tape Out', 'Sub Out', 'Headphone Out'];
